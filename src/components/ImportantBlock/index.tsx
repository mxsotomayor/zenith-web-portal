      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1   lg:grid-cols-2">
          {data.map((item, index) => (
            <div
              key={index}
              className={`${item.className} text-white h-80 p-8 flex flex-col justify-end relative overflow-hidden group transition-all duration-500 ease-in-out cursor-pointer `}
            >
              ...
              <h3 className="font-bold text-2xl z-20 max-w-md group-hover:mb-2 transition-all duration-200 ease-in-out">{item.title}</h3>
