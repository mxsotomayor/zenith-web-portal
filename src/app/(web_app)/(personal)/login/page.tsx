            ...
            <CardContent>
              ...
              <form className="grid gap-y-3">
                <div className="grid gap-y-2">
                  ...
                  <Input id="username" placeholder="Insert Customer Email, Phone, Unibank ID"/>
                  <Link href="#" className="text-xs text-end text-blue-800 underline">You Forgot your Customer ID?</Link>
                </div>
                ...
                <div>
                  <Button className="bg-primary w-full">Create Unibank Account</Button>
                </div>
              </form>
            </CardContent>
          </Card>
